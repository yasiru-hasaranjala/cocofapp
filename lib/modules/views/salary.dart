...
class _SalaryState extends State<Salary> {
  ...
  var dropdVal, dropdV;
  String hintVal = 'Employee', hintV = "By";
  @override
  void initState() {
    super.initState();
    setState(() {
  ...
  void loadData() async {
    DatabaseEvent event = await ref.child("emplys").once();
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  StreamBuilder(
                    stream: ref.child("emplys").onValue,
              ...
              StreamBuilder(
                    stream: ref.child('salary').onValue,
                    builder: (context, snap) {
                      if (snap.hasError) {
                        return const Text('Something went wrong');
                      }
                      ...
                      if(dropdVal != null)
                      {
                        items = items.where((i) => i['emply'] == dropdVal).toList();
                      }
                      if(dropdV != null)
                      {
                    ...
                    return DataTable(
                      ...
                      columns: const[
                          ...
                          DataColumn(label: Center(child: Text("Employee"))),
    ...
    builder: (context) {
      ...
      return AlertDialog(
        title: Row(
          ...
          children: [
            Text(data == null ? 'Salary Pay' : 'Salary Pay Edit'),
          ],
        ),
        content: Row(
